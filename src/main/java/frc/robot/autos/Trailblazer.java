    ...
    var command =
        Commands.runOnce(
            ...
            .alongWith(
              ...
              org.wpilib.command2.CommandScheduler.getInstance()
                .schedule(passedPoint.command);
                        }
