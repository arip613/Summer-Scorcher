...
public class CompBotTunerConstants {
    ...
    //
    // Deliberately NOT a literal here. This file is generated by Phoenix Tuner, and the bus was
    // previously named independently of Hardware.java -- if the two ever disagreed the drivetrain
    // would come up split from its Pigeon rather than failing outright. Referencing the shared
    // definition means a regeneration that clobbers this line is an obvious compile break instead
    // of a subtle runtime one.
    public static final CANBus kCANBus = CanBuses.CANIVORE;
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.45751953125);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.253662109375);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.229736328125);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.088623046875);
