...
public class LeaveNeutralZone {
	...
	public Command omwtoLeaveNeutralZone_red() {
		...
		var segR1_1 = new AutoSegment(constraints, new AutoPoint(localization::getPose), new AutoPoint(FieldPoints.getRB1()));
		var segR1_2 = new AutoSegment(constraints, new AutoPoint(FieldPoints.getRB1()), new AutoPoint(FieldPoints.getRA1()));
		...
		var segR2_1 = new AutoSegment(constraints, new AutoPoint(localization::getPose), new AutoPoint(FieldPoints.getRB2()));
		...
		var chooseSeries1 = (java.util.function.BooleanSupplier) () -> {
			...
			return current.getTranslation().getDistance(FieldPoints.getRB1().getTranslation())
					<= current.getTranslation().getDistance(FieldPoints.getRB2().getTranslation());
		};
	...
	public Command omwtoLeaveNeutralZone_blue() {
		...
		var segB1_1 = new AutoSegment(constraints, new AutoPoint(localization::getPose), new AutoPoint(FieldPoints.getBB1()));
		...
		var segB2_1 = new AutoSegment(constraints, new AutoPoint(localization::getPose), new AutoPoint(FieldPoints.getBB2()));
		var segB2_2 = new AutoSegment(constraints, new AutoPoint(FieldPoints.getBB2()), new AutoPoint(FieldPoints.getBA2()));
		...
		var chooseSeries1 = (java.util.function.BooleanSupplier) () -> {
			var current = localization.getPose();
			return current.getTranslation().getDistance(FieldPoints.getBB1().getTranslation())
					<= current.getTranslation().getDistance(FieldPoints.getBB2().getTranslation());
		};
